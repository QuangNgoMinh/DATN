<div>
    ...
    <a
        ...
        <div class="flex items-center">
            <span>{{ __('Users ') }} {{ __($totalUser) }}</span>
        </div>
        <span>
            <button
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Type Account</th>                            
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <button
                                            ...
                                            aria-label="Edit" wire:click="editUser({{ $user->id }})">
                                        ...
                                        <button
                                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                            aria-label="Delete" wire:click="deleteUser({{ $user->id }})">
                                            <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                                viewBox="0 0 20 20">
    ...
    @if ($createForm == true)
        ...
        <form action="" wire:submit.prevent="store">
            ...
            <select wire:model.lazy="is_admin"
                class="w-full py-3 px-2 my-4 text-sm text-gray-700 placeholder-gray-900 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-dark focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input">
            ...
            <input
                class="w-full py-3 px-2 my-4 text-sm text-gray-700 placeholder-gray-900 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-dark focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input"
                wire:model.lazy="password" type="text" placeholder="Enter Password" />
            @error('password')
                <span class="text-red-600">{{ $message }}</span> <br>
            @enderror
    ...
    @if ($updateForm == true)
        ...
        <form action="" wire:submit.prevent="update({{ $user_id }})">
            ...
            <select wire:model.lazy="edit_is_admin"
                class="w-full py-3 px-2 my-4 text-sm text-gray-700 placeholder-gray-900 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-dark focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input">
                <option selected>Enter type account</option>
                <option value="1">Admin</option>
                <option value="0">User</option>
